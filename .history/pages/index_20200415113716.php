   ...
   <section id="downloads">
       <h4>Downloads</h4>
        <ul class="download-list">
         ...
         <li>You can download our latest newsletter <a href="<?= $this->sitepath('assets/downloads/NewsletterMarch2020.pdf') ?>" download="HBCC Newsletter March 2020.pdf">here.</a></li>
