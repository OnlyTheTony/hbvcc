<article id="bannerholder" class="">
    <div class="cta" id="banner-run" data-delay="5000">
        ...
        <picture>
            <source media="(min-width:769px)" srcset="<?= $this->sitepath('images/banners/bbvcc-front-lg.jpg') ?>">
            <source media="(max-width:768px)" srcset="<?= $this->sitepath('images/banners/bbvcc-front-md.jpg') ?>">
            <source media="(max-width:640px)" srcset="<?= $this->sitepath('images/banners/bbvcc-front-sm.jpg') ?>">
            <source media="(max-width:425px)" srcset="<?= $this->sitepath('images/banners/bbvcc-front-xs.jpg') ?>">
            <img src="<?= $this->sitepath('images/banners/bbvcc-front-lg.jpg') ?>" class="banner">
        </picture>
